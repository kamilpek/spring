		...
		<div class="jumbotron">
			<div class="container">
				...
				<p><a href="<spring:url value="/sellers/add" />" class="btn btn-default">
					<span class="glyphicon glyphicon-plus"></span> dodaj sprzedawce	</a></p>
				<p>
			...
			<c:forEach items="${sellers}" var="seller">
				<div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
					<div class="thumbnail">
						<div class="caption">
							<h3>${seller.name}</h3>							
							<p>NIP: ${seller.nip}, ${seller.city}, ${seller.street}</p>							
							<p>
								<a
									href="<spring:url value="/clients/client?id=${seller.sellerId}" /> "
