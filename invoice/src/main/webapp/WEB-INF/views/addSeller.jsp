...
<body>
	...
	<section class="container">
		<form:form  modelAttribute="newSeller" class="form-horizontal">
			<fieldset>
				<legend>Dodaj nowego sprzedawcę</legend>				
				
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="sellerId">Id</label>
					<div class="col-lg-10">
						<form:input id="sellerId" path="sellerId" type="number" class="form:input-large"/>
					</div>
				</div>
